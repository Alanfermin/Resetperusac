            ...
            <div class="container">
                <div class="row banner__principal__margin">
                    <div class="col s12 l4">
                        <img src="../../imagenes/logo.svg" alt="logo ResetPeruSAC" class="banner__principal__logo">
                    </div>
                    <div class="col s12 l4">
                    ...
                    <div class="col s12 l4 right-align">
                        <div class="col s12">
                            <p class="text-lighten-1 no-padding no-margin">
                                <strong> Telf.: (051) 2220480 - (051) 6640464<br>
                                Cel: 991248450 - 991697142</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <nav class="menu__principal__nav">
                ...
                <a href="#" data-activates="slide-out" class="button-collapse"><i class="jp-align-justify Medium"></i></a>
                    <ul class="left hide-on-med-and-down">
                        ...
                        <li><a href="#" onclick="$('#nosotros').animatescroll({scrollSpeed:2000,easing:'easeInOutBack'});">NOSOTROS</a></li>
                        <li><a href="#" onclick="$('#servicios').animatescroll({scrollSpeed:2000,easing:'easeInOutBack'});" class="menu__principal__ajuste dropdown-button" href="#!" data-activates="dropdown" data-beloworigin="true">SOPORTE TÉCNICO<i class="jp-angle-down"></i></a>
                            <ul id="dropdown" class="dropdown-content collection">
                                <li class="menu__principal__items__cate"><a class="menu__principal__items__link" href="../servicio-tecnico-servidores">SERVIDORES</a></li>
                                <li class="menu__principal__items__cate"><a class="menu__principal__items__link" href="../pc-laptop-redes-reparacion-mantenimiento">PC - LAPTOP - REDES</a></li>
                                <li class="menu__principal__items__cate"><a class="menu__principal__items__link" href="../camaras-filmadoras">CAMARAS Y FILMADORAS</a> </li>
                                <li class="menu__principal__items__cate"><a class="menu__principal__items__link" href="../video-vigilancia">VIDEO VIGILANCIA</a> </li>
                                <li class="menu__principal__items__cate"><a class="menu__principal__items__link" href="../servicio-tecnico-smartphone-celulares">SMARTPHONE - CELULARES</a> </li>
                                <li class="menu__principal__items__cate"><a class="menu__principal__items__link">APPLE</a> </li>
                            </ul>
                        </li>
                ...
                <ul id="slide-out" class="side-nav">
                    ...
                    <div class="background">
                        <img src="imagenes/logo.svg" class="responsive-img" alt="logo-reset-peru-sac">
                    </div>
                    <a href="#!user"><img class="circle" src="../imagenes/reset-peru-grupo-servicios-software-hardware-servidores-enseñanza-auditoria.png" alt="Enseñanza ,asesoria y auditoria personalizado de acuerdo a la necesidad que se presente."></a>
                    ...
                    <li><a href="#!" onclick="$('#nosotros').animatescroll();"><i class="material-icons">person</i>NOSOTROS</a></li>
