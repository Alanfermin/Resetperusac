            ...
            <ul class="slides slides__services">
                <li>
                    ...
                    <div class="caption center-align text-shadow slides__services__fondo">
                      ...
                      <h2 class="bannprinc white-text text-upper white-text text-upper">Soporte técnico</h2>
                ...
                <li>
                    <img src="imagenes/reparapple.png" alt="Apple instalación,reparación,venta de equipos de ultimo modelo,reinstalación de los sistemas operativos para mac,soluciones a la medida en Lima,San Isidro."> 
                        <div class="caption center-align text-shadow slides__services__fondo">
                          <h2 class="bannprinc white-text text-upper ">Apple</h2>
                ...
                <div class="caption center-align text-shadow slides__services__fondo">
                  <h2 class="bannprinc white-text text-upper ">Marketing Digital</h2>
              ...
              <li>
                ...
                <div class="caption center-align text-shadow slides__services__fondo">
                  <h2 class="bannprinc white-text text-upper ">Desarrollo de Páginas Web</h2>
              ...
              <li>
                ...
                <div class="caption center-align text-shadow slides__services__fondo">
                  <h2 class="bannprinc white-text text-upper "> Cursos y Asesorias</h2>
              ...
              <li>
                ...
                <div class="caption center-align text-shadow slides__services__fondo">
                  <h2 class="bannprinc white-text text-upper  ">Cámaras  y Filmadoras</h2>
              ...
              <li>
                ...
                <div class="caption center-align text-shadow slides__services__fondo">
                  <h2 class="bannprinc white-text text-upper ">Celulares - Smarthphone </span></h2>
              ...
              <li>
                ...
                <div class="caption center-align text-shadow slides__services__fondo">
                  <h2 class="bannprinc white-text text-upper ">Video Vigilancia</h2>
              ...
              <li>
                ...
                <div class="caption center-align text-shadow slides__services__fondo">
                  <h2 class="bannprinc white-text text-upper ">Robótica</h2>
