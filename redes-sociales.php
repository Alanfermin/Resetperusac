...
<head>
    ...
    <title>Marketing digital posicione y generar mayores ingresos.</title>
    <meta name="description" content="Community Manager, Redes Sociale, fanpage promocion de tu empresa para captar mayor clientela y generar ingresos">    
    ...
    <section class="redessociales">
            ...
            <div class="container">
                <div class="row topsito">
                    ...
                    <div class="col s12 l6">
                            <img src="imagenes/marketing.jpeg" alt="Marketing digital genere mayores ingresos para su empresa" class="descripcion__img">
                    </div>
                </div>
            </div>    
